...
public class RecurringPriceControllerTest {
    ...
    public void testListAllRecurringPrices() {
        ...
        ResponseEntity<PaginationResponse<RecurringPrice>> recurringPriceResponse = this.restTemplate.exchange("/plugins/RecurringPrice/getAllRecurringPrice", HttpMethod.POST, new HttpEntity<>(request), t);
        Assertions.assertEquals(200, recurringPriceResponse.getStatusCodeValue());
