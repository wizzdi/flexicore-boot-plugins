...
public class PricingSchemeControllerTest {
    ...
    public void testListAllPricingSchemes() {
        ...
        ResponseEntity<PaginationResponse<PricingScheme>> pricingSchemeResponse = this.restTemplate.exchange("/plugins/PricingScheme/getAllPricingSchemes", HttpMethod.POST, new HttpEntity<>(request), t);
        Assertions.assertEquals(200, pricingSchemeResponse.getStatusCodeValue());
