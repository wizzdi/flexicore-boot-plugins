...
@Extension
@Component
public class ChargeReferenceRepository implements Plugin {
    @PersistenceContext
    ...
    public List<ChargeReference> getAllChargeReferences(SecurityContextBase securityContext,
        ...
        Root<ChargeReference> r = q.from(ChargeReference.class);
        List<Predicate> preds = new ArrayList<>();
        addChargeReferencePredicates(filtering, cb, q, r, preds, securityContext);
        q.select(r).where(preds.toArray(Predicate[]::new));
        TypedQuery<ChargeReference> query = em.createQuery(q);
    ...
    public <T extends ChargeReference> void addChargeReferencePredicates(ChargeReferenceFiltering filtering,
        ...
        if (filtering.getChargeReferences() != null && !filtering.getChargeReferences().isEmpty()) {
            preds.add(r.get(ChargeReference_.chargeReference).in(filtering.getChargeReferences()));
        }
