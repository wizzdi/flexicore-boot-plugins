...
public class CreateSchedulingAction{
    ...
    public <T extends CreateSchedulingAction> T setDescription(String description) {
    ...
    public <T extends CreateSchedulingAction> T setDynamicExecutionId(String dynamicExecutionId) {
    ...
    public <T extends CreateSchedulingAction> T setDynamicExecution(DynamicExecution dynamicExecution) {
