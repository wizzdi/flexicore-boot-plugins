...
@Extension
@Component
public class BusinessServiceRepository implements Plugin {
	@PersistenceContext
	...
	public long countAllBusinessServices(SecurityContextBase securityContext,
										 BusinessServiceFiltering filtering) {
		CriteriaBuilder cb = em.getCriteriaBuilder();
	...
	public <T extends BusinessService> void  addBusinessServicePredicates(BusinessServiceFiltering filtering,
