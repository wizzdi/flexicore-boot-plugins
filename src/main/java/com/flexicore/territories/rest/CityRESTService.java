...
public class CityRESTService implements RestServicePlugin {
	...
	public City updateCity(
		...
		Country country = updateContainer.getCountryId()!=null?service.getByIdOrNull(updateContainer.getCountryId(), Country.class, null, securityContext):null;
		if (country == null&&updateContainer.getCountryId()!=null) {
