...
public class AddressImportResponse {
	...
	public <T extends AddressImportResponse> T setCreatedStreet(
			int createdStreet) {
	...
	public <T extends AddressImportResponse> T setCreatedCities(
			int createdCities) {
	...
	public <T extends AddressImportResponse> T setUpdatedStreet(
			int updatedStreet) {
	...
	public <T extends AddressImportResponse> T setUpdatedCities(
			int updatedCities) {
	...
	public <T extends AddressImportResponse> T setUnchangedStreet(
			int unchangedStreet) {
	...
	public <T extends AddressImportResponse> T setUnchangedCities(
			int unchangedCities) {
	...
	public <T extends AddressImportResponse> T setDeletedStreet(
			int deletedStreet) {
	...
	public <T extends AddressImportResponse> T setDeletedCities(
			int deletedCities) {
