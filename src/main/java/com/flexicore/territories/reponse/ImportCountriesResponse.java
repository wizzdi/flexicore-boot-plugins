...
public class ImportCountriesResponse {
	...
	public <T extends ImportCountriesResponse> T setCreatedCountries(
			int createdCountries) {
	...
	public <T extends ImportCountriesResponse> T setExistingCountries(
			int existingCountries) {
