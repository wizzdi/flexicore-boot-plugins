...
public class StateService implements IStateService {
    ...
    @Override
    public PaginationResponse<State> getAllStates(SecurityContext securityContext, StateFiltering filtering) {
    ...
    public void validate(StateCreate stateCreate, SecurityContext securityContext) {
    ...
    public void validate(StateFiltering stateFiltering, SecurityContext securityContext) {
        baseclassNewService.validateFilter(stateFiltering,securityContext);
        Country country = stateFiltering.getCountryId() != null ? getByIdOrNull(stateFiltering.getCountryId(), Country.class, null, securityContext) : null;
        if (country == null && stateFiltering.getCountryId() != null) {
            throw new BadRequestException("no Country with id " + stateFiltering.getCountryId());
        }
        stateFiltering.setCountry(country);
    }

    public State createStateNoMerge(StateCreate stateCreate, SecurityContext securityContext) {
    ...
    public boolean updateStateNoMerge(State state, StateCreate stateCreate) {
        ...
        boolean update = baseclassNewService.updateBaseclassNoMerge(stateCreate,state);
    ...
    public void deleteState(String stateid, SecurityContext securityContext) {
        State state = getByIdOrNull(stateid, State.class, null,
                securityContext);
