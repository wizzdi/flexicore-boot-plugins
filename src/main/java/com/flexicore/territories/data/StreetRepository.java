...
public class StreetRepository extends AbstractRepositoryPlugin {
    ...
    public List<Street> listAllStreets(SecurityContext securityContext, StreetFiltering filtering) {
        ...
        QueryInformationHolder<Street> queryInformationHolder=new QueryInformationHolder<>(filtering,Street.class,securityContext);
        return getAllFiltered(queryInformationHolder,preds,cb,q,r);

    }


    public long countAllStreets(SecurityContext securityContext, StreetFiltering filtering) {
        CriteriaBuilder cb=em.getCriteriaBuilder();
    ...
    private void addStreetPredicate(StreetFiltering filtering, CriteriaBuilder cb, Root<Street> r, List<Predicate> preds) {
