...
public class CountryRepository extends AbstractRepositoryPlugin {
    ...
    public List<Country> listAllCountries(SecurityContext securityContext, CountryFiltering filtering) {
        ...
        QueryInformationHolder<Country> queryInformationHolder=new QueryInformationHolder<>(filtering,Country.class,securityContext);
        return getAllFiltered(queryInformationHolder,preds,cb,q,r);

    }


    public long countAllCountries(SecurityContext securityContext, CountryFiltering filtering) {
        CriteriaBuilder cb=em.getCriteriaBuilder();
    ...
    private void addCountryPredicate(CountryFiltering filtering, CriteriaBuilder cb, Root<Country> r, List<Predicate> preds) {
