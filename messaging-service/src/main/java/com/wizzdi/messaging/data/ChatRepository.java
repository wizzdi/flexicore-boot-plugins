...
public class ChatRepository implements Plugin {
	...
	public <T extends Chat> void addChatPredicates(ChatFilter chatFilter, CriteriaBuilder cb, CommonAbstractCriteria q, From<?, T> r, List<Predicate> predicates, SecurityContext securityContext) {
	...
	public long countAllChats(ChatFilter ChatFilter, SecurityContext securityContext) {
		CriteriaBuilder cb = em.getCriteriaBuilder();
