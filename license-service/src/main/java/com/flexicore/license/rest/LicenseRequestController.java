...
public class LicenseRequestController implements Plugin {
   ...
   @PostMapping("/getAllLicenseRequests")
    ...
    public PaginationResponse<LicenseRequest> getAllLicenseRequests(@RequestBody LicenseRequestFiltering licenseRequestFiltering, @RequestAttribute SecurityContext securityContext) {
   ...
   @PostMapping("/createLicenseRequest")
    ...
    public LicenseRequest createLicenseRequest(@RequestBody LicenseRequestCreate licenseRequestCreate, @RequestAttribute SecurityContext securityContext) {
    ...
    public LicenseRequest updateLicenseRequest(@RequestBody LicenseRequestUpdate licenseRequestUpdate, @RequestAttribute SecurityContext securityContext) {
        String id=licenseRequestUpdate.getId();
        LicenseRequest licenseRequest=id!=null?licenseRequestService.getByIdOrNull(id,LicenseRequest.class, securityContext):null;
