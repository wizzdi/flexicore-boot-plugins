...
public record AlertMessage(String tenantId, String id, AlertLevel alertLevel, String alertContent, String relatedId, String relatedType, String alertCategory,
    ...
    public AlertMessage(Alert alert) {
        this(alert.getTenant().getId(),alert.getId(), alert.getAlertLevel(), alert.getAlertContent(), alert.getRelatedId(), alert.getRelatedType(), alert.getAlertCategory(), alert.getHandledAt(),alert.getCreationDate());
    }
